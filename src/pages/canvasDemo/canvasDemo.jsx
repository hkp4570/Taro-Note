...
import './canvasDemo.less';

let startX = 0; //保存x坐标轴的变量
let startY = 0; //保存y坐标轴的变量
let isClear = false; //是否启用橡皮檫标记
...
export default class extends Component{
  ...
  touchStart(e){
    ...
    if(isClear){
      //清除
      //设置线条样式，颜色设置为画布的背景颜色，橡皮擦原理就是：利用擦过的地方填充画布的背景色
      context.setStrokeStyle('#ddd'); //设置橡皮擦的颜色
  ...
  touchMove(e){
    ...
    if(isClear){
      ...
      context.lineTo(endX,endY); //添加一个新坐标点，然后在画布中创建从该店到最后指定点的线条
